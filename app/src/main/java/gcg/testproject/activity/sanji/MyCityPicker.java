...
public class MyCityPicker implements CanShow, OnWheelChangedListener {
    ...
    private String titleTextColor="#000000"; //标题颜色
    ...
    private MyCityPicker(Builder builder) {
        ...
        popview = layoutInflater.inflate(R.layout.my_pop_city_picker, null);
...
//        popwindow.setAnimationStyle(R.style.AnimBottom);
        ...
        if (!TextUtils.isEmpty(this.titleTextColor)){
            mTvTitle.setTextColor(Color.parseColor(this.titleTextColor));
        }
    ...
    public static class Builder {
        ...
        public Builder titleTextColor(String colorBg){
            this.titleTextColor =colorBg;
            return this;
        }

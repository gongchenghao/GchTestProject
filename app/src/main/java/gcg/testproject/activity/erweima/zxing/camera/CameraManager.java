...
package gcg.testproject.activity.erweima.zxing.camera;
...
import gcg.testproject.activity.erweima.zxing.camera.open.OpenCameraInterface;
	...
	public  void turnLightOff() {
		...
		if (!Camera.Parameters.FLASH_MODE_OFF.equals(flashMode)) {
			...
			if (flashModes.contains(Camera.Parameters.FLASH_MODE_OFF)) {
				...
				Log.i("test", "FLASH_MODE_OFF not supported");
			}
		}
	}
}

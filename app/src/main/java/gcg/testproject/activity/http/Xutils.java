package gcg.testproject.activity.http;
 ...
 */
/**
 * 说明：根据xutils网络框架封装的网络请求类，包括六个个方法，即普通异步get请求，普通异步post请求，带缓存的异步get请求，带缓存的异步post请求，文件上传，文件下载
 * @ClassName:Xutils

 * @PackageName:gcg.testproject.activity.http

 * @Create On 2018/1/26   11:23
...
public class Xutils {
     ...
     * @param callBack
     */
    public void downLoadFile(String url, Map<String, String> maps,String saveFilePath, final XDownLoadCallBack callBack) {
        ...
        params.setSaveFilePath(saveFilePath); //本地文件的路径

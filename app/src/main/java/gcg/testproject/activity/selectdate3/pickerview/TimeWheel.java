package gcg.testproject.activity.selectdate3.pickerview;
...
import gcg.testproject.activity.selectdate3.pickerview.adapters.NumericWheelAdapter;
import gcg.testproject.activity.selectdate3.pickerview.config.PickerConfig;
import gcg.testproject.activity.selectdate3.pickerview.data.source.TimeRepository;
import gcg.testproject.activity.selectdate3.pickerview.utils.PickerContants;
import gcg.testproject.activity.selectdate3.pickerview.utils.Utils;
import gcg.testproject.activity.selectdate3.pickerview.wheel.OnWheelChangedListener;
import gcg.testproject.activity.selectdate3.pickerview.wheel.WheelView;
    ...
    void initView(View view) {
        ...
        switch (mPickerConfig.mType) {
            ...
            case YEAR:
                ...
                break;
            case MIN:
                Utils.hideViews(year,month, day, hour);
                break;
        }

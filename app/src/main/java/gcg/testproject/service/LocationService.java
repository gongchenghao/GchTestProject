package gcg.testproject.service;
...
public class LocationService extends Service {
        ...
        public void onLocationChanged(AMapLocation location) {
            if (null != location) {
                ...
                String result
                        ...
                        +" 定位时间:" + formatUTC(location.getTime(), "yyyy-MM-dd HH:mm:ss"+" 精度:"
    ...
    private void resetOption() {
        ...
        locationOption.setInterval(Long.valueOf("300000"));
        // 设置网络请求超时时间
        locationOption.setHttpTimeOut(Long.valueOf("20000"));
    }
